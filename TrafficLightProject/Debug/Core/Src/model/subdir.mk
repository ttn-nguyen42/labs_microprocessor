...
clean-Core-2f-Src-2f-model:
	-$(RM) ./Core/Src/model/input.d ./Core/Src/model/input.o ./Core/Src/model/input.su ./Core/Src/model/output.d ./Core/Src/model/output.o ./Core/Src/model/output.su ./Core/Src/model/pin.d ./Core/Src/model/pin.o ./Core/Src/model/pin.su
