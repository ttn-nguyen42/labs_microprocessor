...
/* Private defines -----------------------------------------------------------*/
#define O_DOT_Pin GPIO_PIN_4
#define O_DOT_GPIO_Port GPIOA
...
#define O_EN2_Pin GPIO_PIN_8
#define O_EN2_GPIO_Port GPIOA
#define O_EN3_Pin GPIO_PIN_9
#define O_EN3_GPIO_Port GPIOA
